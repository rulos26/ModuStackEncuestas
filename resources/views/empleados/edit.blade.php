                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('empleados.update', $empleado->id) }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" id="telefono" name="telefono" value="{{ old('telefono', $empleado->telefono) }}" required pattern="^[0-9]{6}$" maxlength="6" minlength="6" title="Debe ser un número de 6 dígitos">
