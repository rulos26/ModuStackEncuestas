            ...
            <div class="card-body">
                <form action="{{ route('settings.images.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($settings->logo)
                            <img src="{{ asset('storage/images/logo/logo.png') }}" alt="Logo" height="60" class="mb-2">
                        @endif
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($settings->login_logo)
                            <img src="{{ asset('storage/images/login/login.png') }}" alt="Logo Login" height="60" class="mb-2">
                        @endif
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($settings->dashboard_logo)
                            <img src="{{ asset('storage/images/dashboard/dashboard.png') }}" alt="Logo Dashboard" height="60" class="mb-2">
                        @endif
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($settings->spinner)
                            <img src="{{ asset('storage/images/spinner/spinner.png') }}" alt="Spinner" height="60" class="mb-2">
                        @endif
                    ...
                    <div class="form-group mb-3">
                        ...
                        @if($settings->favicon)
                            <img src="{{ asset('storage/images/favicon/favicon.png') }}" alt="Favicon" height="32" class="mb-2">
                        @endif
