...
@section('content)<div class="row">
    <div class="col-12        <div class="card">
            ...
            <div class="card-body>
                <div class="row">
                    <!-- Limpiar Cachés -->
                    <div class=col-md-6                   <div class="card bg-primary text-white">
                    ...
                    <div class=col-md-6                   <div class="card bg-success text-white">
                            <div class="card-body text-center">
                    ...
                    <!-- Optimizar Rutas -->
                    <div class=col-md-6                   <div class=cardbg-info text-white">
                            <div class="card-body text-center">
                    ...
                    <div class=col-md-6                   <div class="card bg-warning text-white">
                            <div class="card-body text-center">
                ...
                <div class="row mt-4">
                    <div class="col-12                   <button class="btn btn-danger btn-lg" onclick="optimizeAll()">
...
.card:hover {
    transform: translateY(-5n[object Object]   transition: all 0.3s;
}
.btn:hover {
